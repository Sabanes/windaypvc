...
export const alt = "Sistemas Vedaluz | WINDAYPVC"
export const size = {
  width: 1200,
  height: 630,
}
    ...
    >
      <div style={{ display: "flex", alignItems: "center", marginBottom: "20px" }}>
        ...
        <div style={{ marginLeft: "40px", textAlign: "left", color: "white" }}>
          ...
          <div style={{ fontSize: "96px", fontWeight: "bold" }}>Vedaluz</div>
        </div>
      </div>
      <div style={{ fontSize: "32px", color: "white", marginTop: "20px" }}>Máxima Eficiência Energética e Conforto</div>
    </div>,
    { ...size },
  )
}
